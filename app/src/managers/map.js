...
export class MapManager {
    ...
    constructor(game) {
        ...
        this.MAP_BRICK = "-";
        this.MAP_SPACE = "s";
        this.MAP_BRICK_RED = "r";
        this.MAP_BRICK_BROWN = "b";
        this.MAP_BRICK_BLUE = "B";
        this.MAP_BRICK_YELLOW = "y";
        this.MAP_BRICK_ORANGE = "o";
        this.MAP_BRICK_BLACK = "k";
    ...
    drawMap(map) {
        ...
        var startY = 40;
        var die = false;
        var texture = this.textureManager.BRICK_TEXTURE_SETS.purple.normal;
        ...
        for (let index1 = 0; index1 < Math.floor(rows); index1++) { //rows
            ...
            for (let index = 0; index < Math.floor(cols); index++) { //cols
                ...
                map[index1][index] == this.MAP_BRICK_RED ? texture = this.textureManager.BRICK_TEXTURE_SETS.red.normal :
                    map[index1][index] == this.MAP_BRICK_BROWN ? texture = this.textureManager.BRICK_TEXTURE_SETS.brown.normal :
                        map[index1][index] == this.MAP_BRICK_BLUE ? texture = this.textureManager.BRICK_TEXTURE_SETS.blue.normal :
                            map[index1][index] == this.MAP_BRICK_YELLOW ? texture = this.textureManager.BRICK_TEXTURE_SETS.yellow.normal :
                                map[index1][index] == this.MAP_BRICK_ORANGE ? texture = this.textureManager.BRICK_TEXTURE_SETS.orange.normal :
                                    map[index1][index] == this.MAP_BRICK_BLACK ? texture = this.textureManager.BRICK_TEXTURE_SETS.black.normal :
                                        texture = this.textureManager.BRICK_TEXTURE_SETS.purple.normal;
